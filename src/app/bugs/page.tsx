...
export default function BugReport() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({ success: true, message: 'Bug report submitted! Thank you!' });
      ...
      >
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Bug Description */}
            <div>
              <label className="block mb-2 text-gray-300">Describe the Bug</label>
              <textarea
                id="bug"
                value={form.bug}
                onChange={handleChange}
                ...
                placeholder="Describe the bug you encountered, steps to reproduce, and any error messages..."
              />
            </div>
